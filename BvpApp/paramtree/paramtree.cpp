...
void TParamTree::crtGroupInternal()
{
...
//
void TParamTree::crtGroupErrorRemote()
{
    QTreeWidgetItem *top = new QTreeWidgetItem();
...
void TParamTree::crtGroupVp()
{
    ...
    crtItem(top, BVP::PARAM_comPrmBlk08to01, "Блк. команд приемника 08..01");
    crtItem(top, BVP::PARAM_comPrmBlk16to09, "Блк. команд приемника 16..09");
    crtItem(top, BVP::PARAM_comPrmBlk24to17, "Блк. команд приемника 24..17");
    crtItem(top, BVP::PARAM_comPrmBlk32to25, "Блк. команд приемника 32..25");
    crtItem(top, BVP::PARAM_blkComPrm64to33, "Блк. команд приемника 64..33");
    crtItem(top, BVP::PARAM_comPrdBlk08to01, "Блк. команд передатчика 08..01");
    crtItem(top, BVP::PARAM_comPrdBlk16to09, "Блк. команд передатчика 16..09");
